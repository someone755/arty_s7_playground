...
## Switches
set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { SW[0] }]; #IO_L20N_T3_A19_15 Sch=SW0
set_property -dict { PACKAGE_PIN H18   IOSTANDARD LVCMOS33 } [get_ports { SW[1] }]; #IO_L21P_T3_DQS_15 Sch=SW1
set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS33 } [get_ports { SW[2] }]; #IO_L21N_T3_DQS_A18_15 Sch=SW2
set_property -dict { PACKAGE_PIN M5    IOSTANDARD SSTL135  } [get_ports { SW[3] }]; #IO_L6N_T0_VREF_34 Sch=SW3

## RGB LEDs
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { RGBLED0[2] }]; #IO_L23N_T3_FWE_B_15 Sch=LED0_R
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { RGBLED0[1] }]; #IO_L14N_T2_SRCC_15 Sch=LED0_G
set_property -dict { PACKAGE_PIN F15   IOSTANDARD LVCMOS33 } [get_ports { RGBLED0[0] }]; #IO_L13N_T2_MRCC_15 Sch=LED0_B
set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { RGBLED1[2] }]; #IO_L15N_T2_DQS_ADV_B_15 Sch=LED1_R
set_property -dict { PACKAGE_PIN F18   IOSTANDARD LVCMOS33 } [get_ports { RGBLED1[1] }]; #IO_L16P_T2_A28_15 Sch=LED1_G
set_property -dict { PACKAGE_PIN E14   IOSTANDARD LVCMOS33 } [get_ports { RGBLED1[0] }]; #IO_L15P_T2_DQS_15 Sch=LED1_B

## LEDs
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { LED[0] }]; #IO_L16N_T2_A27_15 Sch=LED2
set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVCMOS33 } [get_ports { LED[1] }]; #IO_L17P_T2_A26_15 Sch=LED3
set_property -dict { PACKAGE_PIN E13   IOSTANDARD LVCMOS33 } [get_ports { LED[2] }]; #IO_L17N_T2_A25_15 Sch=LED4
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { LED[3] }]; #IO_L18P_T2_A24_15 Sch=LED5

## Buttons
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { BTN[0] }]; #IO_L18N_T2_A23_15 Sch=BTN0
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { BTN[1] }]; #IO_L19P_T3_A22_15 Sch=BTN1
set_property -dict { PACKAGE_PIN J16   IOSTANDARD LVCMOS33 } [get_ports { BTN[2] }]; #IO_L19N_T3_A21_VREF_15 Sch=BTN2
set_property -dict { PACKAGE_PIN H13   IOSTANDARD LVCMOS33 } [get_ports { BTN[3] }]; #IO_L20P_T3_A20_15 Sch=BTN3
...
#set_property -dict { PACKAGE_PIN V16   IOSTANDARD SSTL135   IN_TERM UNTUNED_SPLIT_50   SLEW FAST } [get_ports { jc2_d_i }]; #IO_L18N_T2_A11_D27_14 Sch=jc2/ck_io[40]
#set_property -dict { PACKAGE_PIN U17   IOSTANDARD SSTL135   IN_TERM UNTUNED_SPLIT_50   SLEW FAST } [get_ports { jc3_s_i }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=jc3/ck_io[39]
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD SSTL135   SLEW FAST } [get_ports { jc4_s_o }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=jc4/ck_io[38]
#set_property -dict { PACKAGE_PIN U16   IOSTANDARD SSTL135   SLEW FAST } [get_ports { jc7_d_o }]; #IO_L16P_T2_CSI_B_14 Sch=jc7/ck_io[37]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports { jc2_d_i }]; #IO_L18N_T2_A11_D27_14 Sch=jc2/ck_io[40]
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports { jc3_s_i }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=jc3/ck_io[39]
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports { jc4_s_o }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=jc4/ck_io[38]
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports { jc7_d_o }]; #IO_L16P_T2_CSI_B_14 Sch=jc7/ck_io[37]
...
## DDR3 connections.
## Based on https://github.com/Digilent/digilent-mig/blob/master/Arty-S7-50/mig.ucf
## Copied in part from MIG generated output XDC file.
